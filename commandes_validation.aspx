  ...
  CommandText = "Select clients_new.CodeClient,num_commande,dtcomm,societe,modele,prix_valideur,prix_pointfort,langue FROM commandes_portes "
        ...
        Else
            Dim MaTrad As New Tool_fichet
             if session("pays")="BE"
				...
				Button3.Text = MaTrad.traduction(Session("langue"), "COMMANDES_VALIDATION", "BTN1")
			 else
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
		...
		'aeh
       	 Select Case Session("charte").ToString().ToUpper()
				...
				Case "YALE"
					sPATH =  "/commandes_yale/"
				Case "SHER"
					sPATH =  "/commandes_sherlock/"
				Case "REHAB"
					sPATH =  "/commandes_rehab/"
                Case "FSBA"
					sPATH =  "/commandes_rehab/"
				Case Else
    ...
    Private Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.Header Then
			...
			' e.Row.Cells(7).Text = MaTrad.traduction(Session("langue"), "COMMANDES_VALIDATION", "COL6")
...
Sub maj_econelement(ByVal wConfig As String,byval wtext as string)

			

			Dim sql As String = " update eConElements SET content=cast(replace(cast(content as nvarchar(max)),'codearemplacer','" & wtext &"') as ntext) where name ='" & wconfig & "'"
		


		 Dim conn As New SqlConnection(System.Configuration.ConfigurationManager.AppSettings("ConnectionStringEcon"))
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs)
		...
		Dim RefAX as New TextBox
        
          dim lien as new HyperLink
        ...
        If TextBox1.Text <> "" Then
            If signature(TextBox1.Text) Then
                ...
                For i = 0 To GridView1.Rows.Count - 1
					...
					lien = GridView1.Rows(i).FindControl("hlID")
					RefAX = GridView1.Rows(i).FindControl("RefAX")
                    If bSelect.Checked Then
						If RefValideur.Text.Trim <> "" and RefAx.text.Trim <> "" Then
							maj_status(GridView1.DataKeys(i).Value.ToString(), RefValideur.Text.Trim)
								
									maj_econelement(MyTool.get_order_info(lien.text.Trim.ToString(), "configuration"),RefAx.text.trim)
...
<asp:Content ContentPlaceHolderID="e_body" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" CellPadding="4" AutoGenerateColumns="False"
        ...
        <Columns>
			...
			<asp:TemplateField HeaderText="Ref AX">
                <ItemTemplate>
                    <asp:TextBox ID="RefAX" runat="server" />
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td colspan="2" style="text-align: center">
                <% if session("pays")="BE"%> 
					<asp:Button ID="Button3" runat="server" Text="Valider" OnClick="Button3_Click" />
				<%Else%>
