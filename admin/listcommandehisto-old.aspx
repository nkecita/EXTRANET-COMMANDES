...
<script runat="server">
    ...
    Sub Page_Load(ByVal Sender As Object, ByVal E As EventArgs)
        ...
        If Session("filtre") <> "" Then
            SqlDataSource3.SelectCommand = "SELECT [num_commande], [dtcomm],hrcomm,[societe], [num_client], [ref_client], [delai],  [prix_valideur],[prix_pointfort], [modele],status FROM [commandes_portes] where 1=1" & " AND Environnement ='" & cEnviron & "'"  & Session("filtre") & "order by num_commande desc "
        Else
            SqlDataSource3.SelectCommand = "SELECT [num_commande], [dtcomm],hrcomm,[societe], [num_client], [ref_client], [delai],  [prix_valideur],[prix_pointfort], [modele],status FROM [commandes_portes] where Environnement ='" & cEnviron & "'" & "order by num_commande desc "
    ...
    Protected Sub GridView3_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles Gridview3.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Cells(9).Text = "<a href='" & sPATH  & tabName(0) & "/" & tabName(1) & "/CEW" & Lblcde.Text.Trim.PadLeft(7, "0") & "_AT.HTML" & "' target='_BLANK'><img src='images/cle.png'  border='0'></a>"
            ...
            If recupvalideur <> "" Then
                ...
                e.Row.Cells(6).Text = ToolRecup.get_order_info(Lblcde.Text.Trim, "ref_valideur")
                    ...
                    e.Row.Cells(7).Text = "<a href='" & sPATH  & tabName(0) & "/" & tabName(1) & "/CEW" & Lblcde.Text.Trim.PadLeft(7, "0") & "_TA.HTML" & "' target='_BLANK'>" & e.Row.Cells(7).Text & "</a>"
...
<asp:Content ContentPlaceHolderID="e_body" runat="server">
    ...
    <asp:GridView ID="Gridview3" runat="server" CellPadding="3" ForeColor="Black" EnableViewState="False"
        ...
        <Columns>
            <asp:HyperLinkField DataTextField="num_commande" DataNavigateUrlFormatString="appel_commande.aspx?num_commande={0}&type=FR.aspx"
                DataNavigateUrlFields="num_commande" Target="_blank" HeaderText="Commande" />
